...
const seedVendors = [
  ...
  { id: 'extreme', name: 'Extreme Networks', products: 'Universal Switches、数据中心交换机、无线、云网管与网络安全', domains: ['extremenetworks.com', 'extr-p-001.sitecorecontenthub.cloud'], primaryEvidence: '官方系列产品页明确关联的 Data Sheet PDF', strategy: '从 Products 产品目录按类别发现系列；仅采集系列页 View Data Sheet 实际指向的 Sitecore Content Hub 官方 PDF，禁止猜测内容名称或版本参数。', healthUrl: 'https://www.extremenetworks.com/products/switches/universal-switches/4000-series', status: 'verified', lastVerified: '2026-08-20' }
];
